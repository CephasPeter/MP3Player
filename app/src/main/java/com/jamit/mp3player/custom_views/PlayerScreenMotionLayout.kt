package com.jamit.mp3player.custom_views
...
/*****
 * This Class tries to mimics The Youtube Music DropDown Music Player
 */
class PlayerScreenMotionLayout (context: Context, attributeSet: AttributeSet? = null) : MotionLayout(context, attributeSet) {
    ...
    init {
        ...
        super.setTransitionListener(object : MotionLayout.TransitionListener {
            ...
            override fun onTransitionChange(p0: MotionLayout?, p1: Int, p2: Int, p3: Float) {
                transitionListenerList.filterNotNull().forEach { it.onTransitionChange(p0, p1, p2, p3) }
            }
